...
export interface Datum<T = any> extends Query<T> {
     ...
     */
    lookup<U = any, TK extends keyof T = keyof T>(other: Stream<U>, localKey: TK, otherKey: keyof U): Datum<Omit<T, TK> & Record<TK, T[TK] extends any[] ? U[] : U>>;
    /**
...
export interface Stream<T = any> extends Query<T[]> {
     ...
     * @param otherKey Key in other table
     */
    lookup<U = any, TK extends keyof T = keyof T>(other: Stream<U>, localKey: TK, otherKey: keyof U): Stream<Omit<T, TK> & Record<TK, T[TK] extends any[] ? U[] : U>>;
    /**
